...
OhdsiRTools::checkUsagePackage("Covid19EstimationMentaldisorder")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/Covid19EstimationMentaldisorder.pdf")
shell("R CMD Rd2pdf ./ --output=extras/Covid19EstimationMentaldisorder.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "Covid19EstimationMentaldisorder")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("Covid19EstimationMentaldisorder")
