Covid19EstimationMentaldisorder
==============================
...
2. In `R`, use the following `devtools` command to install the Covid19EstimationMentaldisorder package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/Covid19EstimationMentaldisorder"
...
License
=======
The Covid19EstimationMentaldisorder package is licensed under Apache License 2.0

Development
===========
Covid19EstimationMentaldisorder was developed in ATLAS and R Studio.
